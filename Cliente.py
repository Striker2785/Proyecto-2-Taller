...
class Game_State():
	...
	def enter_name(self):
		for event in pygame.event.get():
			...
			if event.type == KEYDOWN:
				btn_sound.play() 
				textbox.add_character(pygame.key.name(event.key))
	...
	def menu(self):
		...
		draw_text(screen, "pyDakarDeath", 65, screen_width // 2, screen_height // 4 - 100)
	...
	def main_game(self):
		...
		p2.x = p2Pos[0]
		p2.y = p2Pos[1]
		hits = pygame.sprite.groupcollide(players_list, dummycars_list, False, True)
